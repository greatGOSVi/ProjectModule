...
public class AuthorizationServerConfiguration {
	 ...
	 * registeredClientRepository(JdbcTemplate jdbcTemplate) { // Register
	 * authorized clients. RegisteredClient registeredClient =
	 * RegisteredClient.withId(UUID.randomUUID().toString())
	 * .clientId("pets-client") .clientSecret("{noop}secret")
	...
	public ProviderSettings providerSettings() {
		return ProviderSettings.builder().issuer("http://10.5.0.6:9000").build();
	}
